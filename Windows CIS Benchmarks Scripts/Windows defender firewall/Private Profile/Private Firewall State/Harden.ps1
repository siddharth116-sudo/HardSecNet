<#
.SYNOPSIS
Applies CIS Benchmark 9.2.1: Sets 'Windows Firewall: Private: Firewall state' to 'On (recommended)'.

.DESCRIPTION
This script sets the registry key that controls the firewall state for the Private Profile to '1' (On).
This ensures that the host-based firewall is always running when connected to a private network,
...
$CIS_ID = "9.2.1 (L1)"
$CIS_NAME = "Windows Firewall: Private: Firewall state"
$REQUIRED_VALUE = 1
$SETTING_NAME = "Private Profile Firewall State"
